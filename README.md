...
- Имеются маленькие недочеты на сайте рейтингов
- Долгая инициализация темы на клиенте(10-20секунд)
- Отсутствие ховер анимации на кнопке премиума в лобби
- Рваная трансформация карточек при наведении курсора
- Проблемы с адаптивом дочерних элементов в лобби
- Проблемы с залипанием ховера в списке битв
- Проблемы с новой вариацией таба, резистам в дм катках очень страшно и они смещаются правее
