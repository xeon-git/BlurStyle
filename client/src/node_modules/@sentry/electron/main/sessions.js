...
function checkPreviousSession(crashed) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (previousSession && client) {
            ...
            const sesh = (0, hub_1.makeSession)(previousSession);
            (0, hub_1.updateSession)(sesh, {
                status,
                errors: (sesh.errors || 0) + 1,
                release: (_a = previousSession.attrs) === null || _a === void 0 ? void 0 : _a.release,
                environment: (_b = previousSession.attrs) === null || _b === void 0 ? void 0 : _b.environment,
            });
...
function sessionCrashed() {
    ...
    if (session.status === 'ok') {
        ...
        (0, hub_1.updateSession)(session, { status: 'crashed', errors: (session.errors += 1) });
    }
    else {
