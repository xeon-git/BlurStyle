...
function makeElectronOfflineTransport(options) {
    ...
    const queue = new queue_1.PersistedRequestQueue((0, path_1.join)(fs_1.sentryCachePath, 'queue'));
    ...
    function flushQueue() {
        queue
            ...
            if (found) {
                ...
                makeRequest(found).catch((e) => utils_1.logger.error(e));
            }
        })
