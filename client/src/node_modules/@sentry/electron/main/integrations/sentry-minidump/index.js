...
class SentryMinidump {
    ...
    setupOnce() {
        ...
        this._scopeStore = new store_1.Store(fs_1.sentryCachePath, 'scope_v2', new core_1.Scope());
        ...
        (0, electron_normalize_1.onRendererProcessGone)(electron_normalize_1.CRASH_REASONS, (contents, details) => this._sendRendererCrash(options, contents, details));
        (0, electron_normalize_1.onChildProcessGone)(electron_normalize_1.CRASH_REASONS, (details) => this._sendChildProcessCrash(options, details));
    ...
    _setupScopeListener() {
        ...
        if (hubScope) {
            hubScope.addScopeListener((updatedScope) => {
                ...
                (_a = this._scopeStore) === null || _a === void 0 ? void 0 : _a.set(scope);
            });
        }
    }
    /**
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (minidumps.length > 0) {
                    ...
                    const storedScope = core_1.Scope.clone(this._scopeLastRun);
