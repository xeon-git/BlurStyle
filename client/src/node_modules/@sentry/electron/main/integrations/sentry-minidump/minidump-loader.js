...
function crashpadMinidumpLoader() {
    ...
    return createMinidumpLoader(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const dumpDirectory = (0, path_1.join)(crashesDirectory, crashpadSubDirectory);
        return (yield (0, fs_1.readDirAsync)(dumpDirectory))
            .filter((file) => file.endsWith('.dmp'))
            .map((file) => {
            const path = (0, path_1.join)(dumpDirectory, file);
            return {
                path,
