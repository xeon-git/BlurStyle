...
class ElectronMinidump {
    ...
    setupOnce() {
        ...
        const previousSessionCrashed = (0, sessions_1.unreportedDuringLastSession)((_b = electron_1.crashReporter.getLastCrashReport()) === null || _b === void 0 ? void 0 : _b.date);
        // Check if a previous session was not closed
        (0, sessions_1.checkPreviousSession)(previousSessionCrashed).catch((error) => utils_1.logger.error(error));
    }
    /**
