...
exports.mkdirpSync = exports.mkdirp = exports.renameAsync = exports.readDirAsync = exports.unlinkAsync = exports.statAsync = exports.mkdirAsync = exports.readFileAsync = exports.writeFileAsync = exports.sentryCachePath = void 0;
...
function mkdirp(path) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            return (0, exports.mkdirAsync)(realPath, 0o777);
        }
        catch (err) {
            const error = err;
...
function mkdirpSync(path) {
    const realPath = (0, path_1.resolve)(path);
    try {
        (0, fs_1.mkdirSync)(realPath, 0o777);
    }
    catch (err) {
        const error = err;
        if (error && error.code === 'ENOENT') {
            mkdirpSync((0, path_1.dirname)(realPath));
            (0, fs_1.mkdirSync)(realPath, 0o777);
        }
        else {
            try {
